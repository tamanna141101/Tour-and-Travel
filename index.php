    ...
    <div class="container">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-6 col-sm-12 col-lg-4 filterDiv weekend">
                <div class="card"">
                    <img src=" https://images.pexels.com/photos/4028822/pexels-photo-4028822.jpeg?auto=compress&cs=tinysrgb&w=600"
                    class="card-img-top" alt="...">
                    <div class="card-body">
                        <p><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i> 38 Reviews</p>
            ...
            <div class="col-md-6 col-sm-12 col-lg-4 filterDiv holidays">
                <div class="card"">
                    <img src=" https://images.pexels.com/photos/11734284/pexels-photo-11734284.jpeg?auto=compress&cs=tinysrgb&w=600"
                    class="card-img-top" alt="...">
                    <div class="card-body">
                        <p><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i> 38 Reviews</p>
            ...
            <div class="col-md-6 col-sm-12 col-lg-4 filterDiv specialTour">
                <div class="card"">
                    <img src="https://images.pexels.com/photos/4825701/pexels-photo-4825701.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    class="card-img-top" alt="...">
                    <div class="card-body">
                        <p><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i> 38 Reviews</p>
